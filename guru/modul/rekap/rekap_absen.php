...
<!-- <div class="panel-header bg-primary-gradient"><div class="page-inner py-5"></div></div> -->
...
<div class="page-inner">
	<div class="page-header">
		...
		<ul class="breadcrumbs">
			...
			<li class="nav-item"><a href="">KELAS (<?=strtoupper($d['nama_kelas']) ?> )</a></li>
			<li class="separator"><i class="flaticon-right-arrow"></i></li>
			<li class="nav-item"><a href=""><?=strtoupper($d['mapel']) ?></a></li>
		</ul>
	</div>	
		...
		<div class="card">
			<div class="card-body"> -->
				<!-- 	<div class="card-list">
					...
					<a href="modul/rekap/rekap_bulan.php?pelajaran=<?=$_GET[pelajaran] ?>&bulan=<?=$bulan-1;?>" class="btn btn-warning btn-block text-left" target="_blank"><i class=" fas fa-file-alt"></i> BULAN SEBELUMYA</a>	</div> -->				
				...
				<?php $bulan = date('m',strtotime($bulan['tgl_absen']));?>
...
<center><a href="javascript:history.back()" class="btn btn-default"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
</center>
</div>