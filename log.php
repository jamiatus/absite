...
<head>
    ...
    <title>Absite MA An-Nur</title>
    <meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
    <link rel="icon" href="assets/img/ogo1.png" type="image/x-icon" />
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        ...
                        <b class="text-white">Absite MA An-Nur</b>
                    </a>
                </div>
            </div>
            <!-- End Logo Header -->
        ...
        <div class="main-panel">
                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">MA AN-NUR</h2>
                                    <!-- <h5 class="text-white op-7 mb-2">Absen Lebih mudah gunakan Aplikasi Absensi</h5> -->
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2">Pulau Sabira</a>
            ...
            <footer class="footer">
                <div class="container">
                    ...
                    &copy; <?php echo date('Y');?> Absite MA AN-NUR (<a href=https://drive.google.com/drive/folders/1mzVJWcE3p5OrzQT06hjmPPyi2oG7Nsl9>Kelompok 3 5AB PIF </a> | 2022)
                    </div>
                </div>
            </footer>
