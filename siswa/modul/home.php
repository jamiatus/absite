<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">ABSITE</h2>
							...
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="card-category">
										<center> Jl. KH. Muntaha Kembang Jeruk Banyuates Sampang 69263
							...
							<!-- 	<div class="card-header">
								...
								<div class="card-body">
									...
									<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
										...
										<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon" align="justify">
											<p>
												<hr>

												ABSITE merupakan sebuah sistem informasi absensi berbasis web yang dikembangkan dengan tujuan untuk mempermudah dalam proses pendataan absensi siswa di MA An-Nur Kembang Jeruk Banyuates.
											</p>
										</div>
										</div>
									</div>
