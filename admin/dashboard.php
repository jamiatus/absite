...
<head>
	...
	<title>Administrator | Absite MA An-Nur</title>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">MA AN-NUR</b>
				</a>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							<a class="collapse" href="?page=jadwal">
								<i class="fas fa-clipboard-list"></i>
								<span class="sub-item"> Jadwal Mengajar </span>
							</a>
						</li>

						<li class="nav-item">
							<a class="collapse" href="?page=guru">
						...
						<li class="nav-item">
							<a class="collapse" href="?page=siswa">
