<div class="page-inner">
          <div class="page-header">
            ...
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="?page=master&act=mapel#base">Data Umum</a>
              </li>
              <li class="separator">
                <i class="flaticon-right-arrow"></i>
              </li>
              <li class="nav-item">
                <a href="?page=master&act=mapel">Daftar Mata Pelajaran</a>
              </li>
            </ul>
          </div>
          <div class="row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php 
                if (isset($_POST['edit'])) {
                    $save= mysqli_query($con,"UPDATE tb_mapel SET mapel='$_POST[mapel]' WHERE id_mapel='$_POST[id]' ");
                    if ($save) {
                        echo "
                        <script type='text/javascript'>
                        setTimeout(function () { 

                        swal('Sukses', 'Mata Pelajaran Berhasil diubah', {
                        icon : 'success',
                        buttons: {              
                        confirm: {
        ...
        <div class="modal-content">
           <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <?php 
                if (isset($_POST['save'])) {
                    $save= mysqli_query($con,"INSERT INTO tb_mapel VALUES(NULL,'$_POST[kode]','$_POST[mapel]') ");
                    if ($save) {
                        echo "<script>
