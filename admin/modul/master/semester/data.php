<div class="page-inner">
          <div class="page-header">
            ...
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="?page=master&act=semester#base">Data Umum</a>
              </li>
              <li class="separator">
                <i class="flaticon-right-arrow"></i>
              </li>
              <li class="nav-item">
                <a href="?page=master&act=semester">Daftar Semester</a>
              </li>
            </ul>
          </div>
          <div class="row">
            ...
            <div class="modal-body">
                ...
                if (isset($_POST['edit'])) {
                    ...
                    if ($save) {
                        ...
                        swal('Sukses', 'Semester Berhasil diubah', {
                        icon : 'success',
                        buttons: {              
                        confirm: {
            ...
            <div class="modal-body">
                ...
                if (isset($_POST['save'])) {
                    ...
                    if ($save) {
                        ...
                        swal('Tambah Semester', 'Semester Berhasil ditambahkan', {
                        icon : 'success',
                        buttons: {              
                        confirm: {
                        className : 'btn btn-success'
