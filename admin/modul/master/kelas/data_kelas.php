<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
			...
			<li class="nav-item">
				<a href="?page=master&act=kelas#base">Data Umum</a>
			</li>
			<li class="separator">
				<i class="flaticon-right-arrow"></i>
			</li>
			<li class="nav-item">
				<a href="?page=master&act=kelas">Daftar Kelas</a>
			</li>
		</ul>
	</div>
					...
					<table class="table table-sm">
						...
						<tbody>
                            ...
                            <tr>
                                ...
                                href="?page=master&act=delkelas&id=<?=$k['id_mkelas'] ?>"><i class="fas fa-trash"></i> Del</a>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        if (isset($_POST['edit'])) {
                                            ...
                                            if ($save) {
                                                ...
                                                swal('Sukses', 'Kelas Berhasil diubah', {
                                                icon : 'success',
                                                buttons: {              
                                                confirm: {
...
<div id="addKelas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                ...
                if (isset($_POST['save'])) {
                    ...
                    if ($save) {
                        ...
                        swal('Tambah Kelas', 'Kelas Berhasil ditambahkan', {
                        icon : 'success',
                        buttons: {              
                        confirm: {
                        className : 'btn btn-success'
