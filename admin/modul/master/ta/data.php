<div class="page-inner">
          <div class="page-header">
            ...
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="?page=master&act=ta#base">Data Umum</a>
              </li>
              <li class="separator">
                <i class="flaticon-right-arrow"></i>
              </li>
              <li class="nav-item">
                <a href="?page=master&act=ta">Daftar Tahun Pelajaran</a>
              </li>
            </ul>
          </div>
          <div class="row">
            ...
            <div class="modal-body">
                ...
                if (isset($_POST['edit'])) {
                    ...
                    if ($save) {
                        ...
                        swal('Sukses', 'Tahun Ajaran Berhasil diubah', {
                        icon : 'success',
                        buttons: {              
                        confirm: {
            ...
            <div class="modal-body">
                ...
                if (isset($_POST['save'])) {
                    ...
                    if ($save) {
                        ...
                        swal('Tambah Tahun', 'Tahun Ajaran Berhasil ditambahkan', {
                        icon : 'success',
                        buttons: {              
                        confirm: {
                        className : 'btn btn-success'
